...
<head>
  ...
  <title>Web Programming Nizar</title>
</head>
...
<body id="home" class="home scrollspy">
    ...
    <nav class="indigo darken-2">
      <div class="container">
        <div class="nav-wrapper">
          <a href="#home" class="brand-logo">WPN</a>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col m6 light">
          ...
          <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean sed semper tortor. Maecenas tincidunt ac
            leo in hendrerit. Nam fermentum mauris at risus commodo, vel facilisis turpis commodo. Pellentesque tempor
            vel massa sed tempor. In sed arcu nisi. Nullam feugiat pharetra leo in pellentesque.</p>
        </div>
        <div class="col m6 light">
          <p>WEB DEVELOPMENT</p>
          <div class="progress">
            <div class="determinate indigo" style="width: 95%"></div>
          </div>
          <p>MOBILE APP DEVELOPMENT</p>
          <div class="progress">
            <div class="determinate indigo" style="width: 80%"></div>
          </div>
          <p>DESKTOP DEVELOPMENT</p>
          <div class="progress">
            <div class="determinate indigo" style="width: 85%"></div>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        ...
        <div class="col m4 s12">
          <div class="card-panel center">
            ...
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur maximus.</p>
          </div>
        </div>
        <div class="col m4 s12">
          <div class="card-panel center">
      ...
      <div class="row">
        <div class="col m5 s12">
          ...
          <ul class="collection with-header">
            ...
            <li class="collection-item">Web Programming Nizar</li>
            <li class="collection-item">Jl. Kulon Asem No.2, Kudus</li>
            <li class="collection-item">Central Java, Indonesia</li>
          </ul>
        </div>
        <div class="col m7 s12">
          <form>
            <div class="card-panel">
              ...
              <div class="input-field">
                <input type="tel" name="phone" id="phone" class="validate" pattern="[0-9]{3}-[0-9]{2}-[0-9]{3}" />
              ...
              <button class="btn indigo darken-2" type="submit">Send</button>
            </div>
          </form>
        </div>
      </div>
  ...
  <footer class="indigo darken-2 white-text center">
    <p class="flow-text">Web Programming Nizar. Copyright 2022</p>
  </footer>
